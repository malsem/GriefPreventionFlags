...
public class GPFlagsConfig {
    ...
    public void loadConfig() {
        ...
        if (!plugin.registeredFlagDefinitions) {
            ...
            this.flagManager.registerFlagDefinition(new FlagDef_JoinLocation(this.flagManager, plugin));
            this.flagManager.registerFlagDefinition(new FlagDef_NoInvisible(this.flagManager, plugin));
